...
public class ApplyMetadataService extends BaseService {
    ...
    public void process(Exchange exchange) {
        ...
        MetadataAdditionResponse metadataAdditionResponse = new MetadataAdditionResponse("Not Implemented");
        setupResponse(exchange, "200", metadataAdditionResponse, MetadataAdditionResponse.class);
    }
